...
mv /tmp/lab-app/quick-oil-part7/* /var/www/html
mv /tmp/lab-app/quick-oil-part7/scripts/* /var/www/html/scripts
mv /tmp/lab-app/quick-oil-part7/images/* /var/www/html/images
rm -rf /tmp/lab-app/
