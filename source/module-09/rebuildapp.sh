...
cp -rf /tmp/lab-app/quick-oil-part7/* /var/www/html/
cp -rf /tmp/lab-app/quick-oil-part7/scripts/* /var/www/html/scripts/
cp -rf /tmp/lab-app/quick-oil-part7/images/* /var/www/html/images/
rm -rf /tmp/lab-app/
